    ...
    <div className="fixed inset-0 z-[99999] bg-black/50 backdrop-blur-sm overflow-y-auto" onClick={onClose}>
      <div className="min-h-full flex items-center justify-center p-4">
        ...
        <div className="p-6 border-b border-slate-200 flex items-center justify-between">
          <h2 className="text-2xl font-black text-sky-600">Edit Profile</h2>
        ...
        <div className="p-6">
          ...
          <div className="flex flex-col items-center mb-8">
            <div className="relative group cursor-pointer" onClick={() => fileInputRef.current?.click()}>
              <div className="w-24 h-24 rounded-full overflow-hidden border-4 border-sky-500 bg-slate-100 flex items-center justify-center">
            ...
            <p className="text-sm font-bold text-slate-500 mt-3 cursor-pointer hover:text-sky-600" onClick={() => fileInputRef.current?.click()}>
              Change Photo
            </p>
          ...
          <form id="profile-form" onSubmit={handleSubmit} className="space-y-5">
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border-2 border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-sky-500"
                />
              </div>
              <div>
            ...
            <div>
              <label className="block text-sm font-bold text-slate-700 mb-1">Role (Read Only)</label>
              <input
                type="text"
                readOnly
                value="Administrator"
        ...
        <div className="p-6 border-t border-slate-200 bg-slate-50">
          <button
            ...
            form="profile-form"
            disabled={loading}
            className="w-full py-3 bg-gradient-to-r from-sky-500 to-blue-600 text-white rounded-xl font-bold hover:shadow-lg transition-all flex items-center justify-center gap-2 disabled:opacity-50"
          >
