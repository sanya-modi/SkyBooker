...
export function FlightResultCard({
  ...
  return (
    <article
      ref={cardRef}
      className="frc-card bg-white rounded-2xl border border-slate-100 overflow-hidden"
      style={{ boxShadow: '0 2px 12px rgba(0,35,111,0.06)' }}
      ...
      <div className="px-5 py-4 flex flex-wrap items-center gap-3 border-b border-slate-100">
        ...
        <div className="flex items-center gap-4 flex-1 min-w-0">
          ...
          <div className="text-center">
            ...
            <p className="text-xs font-bold text-[#1e3a8a] tracking-widest mt-0.5">
              {flight.departureAirport?.iataCode ?? '—'}
            </p>
            <p className="text-[10px] text-slate-400 font-medium">{flight.departureAirport?.city}</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-[10px] text-slate-400 font-medium">{flight.arrivalAirport?.city}</p>
          </div>
        </div>
